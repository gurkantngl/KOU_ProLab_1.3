...
public class GuiKangrubu extends JComponent {
    static Random rand = new Random();
    public static void main(String[] args, String kanGrubu) throws IOException, ParseException { 
        ArrayList <PersonNode> butunKisiler = new ArrayList<>();
        ...
        if (NodeTree.getRoot().Es == null) {
            ...
            butunKisiler.add(NodeTree.getRoot());
            ...
            butunKisiler.add(NodeTree.getRoot().Es);
        ...
        renklendir(kanGrubu, butunKisiler);
    }
    ...
    static void renklendir(String kanGrubu, ArrayList<PersonNode> butunKisiler){
        for(PersonNode node : butunKisiler){
            if(node.getKanGrubu().contains(kanGrubu)){
                node.nodeBtn.setBackground(Color.red);
            }
            if(node.Es != null ){
                if(node.Es.getKanGrubu() != null){
                if(node.Es.getKanGrubu().contains(kanGrubu))
                    node.Es.nodeBtn.setBackground(Color.red);
            }
        }
        }
    }
