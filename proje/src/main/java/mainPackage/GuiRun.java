...
public class GuiRun extends JComponent {
            ...
            while (!queue.isEmpty()) {
                ...
                for (int k = 0; k < cizilecekler.size(); k++) {
                    if (cizilecekler.size() % 2 == 0) {
                        if(k!=0 && cizilecekler.get(k-1).Es == null){
                            btnList.get(k).setLocation(
                               btnList.get(k-1).getLocation().x + 140, y);
                        }else
                            btnList.get(k).setLocation(
                                spacing + (k * 280), y);
                    } else {
                    ...
                    if(cizilecekler.get(k).getCinsiyet().equals("Erkek"))
                        btnList.get(k).setBackground(new Color(0,0,255));
                    else
                        btnList.get(k).setBackground(new Color(255,0,255));
                    btnList.get(k)
                    ...
                    if(k == cizilecekler.size()-1){
                        ...
                        if(cizilecekler.get(k).getChildren().size() != 0){
                            btnciz.setSize((cizilecekler.get(k).getChildren().get(0).nodeBtn.getLocation().x + 50) - cizilecekler.get(k).getChildren().get(cizilecekler.get(k).getChildren().size() - 1).nodeBtn.getLocation().x, 5);
                    ...
                    if (cizilecekler.get(k).Es != null) {
                        ...
                        if(cizilecekler.get(k).getCinsiyet().equals("Erkek"))
                            btnEs.setBackground(new Color(255,0,255));
                        else
                            btnEs.setBackground(new Color(0,0,255));
